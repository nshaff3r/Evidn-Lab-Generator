...
class Lab:
    def __init__(self, name, week_avg, month_avg, energy_saved, building):
        self.name = name
...
def demonstration():
    ...
    lab003 = Lab("Lab 114", 5.525213, 5.39672, -0.064247, ichan)
...
test.shapes[1].text_frame.fit_text(font_family='title', font_file='Poppins-Regular.ttf', max_size=28, bold=True)
...
# test.shapes[1].text = ichan_demo.labs[0].name
# for shape in test.shapes:
#     if shape.has_text_frame:
#         print(test.shapes.index(shape), shape.text)
